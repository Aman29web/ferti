...
const InnovationBlock = () => {
  return (
  <section className="bg-gradient-to-br from-[#005E34] to-[#0B3E2A] text-white px-6 md:px-16 py-16 rounded-tl-[60px] rounded-br-[60px] max-w-7xl mx-2.5 md:mx-auto mt-12">
