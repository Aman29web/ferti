...
const FertilizerInfo = () => {
  return (
   <section className="bg-gradient-to-br from-[#005E34] to-[#0B3E2A] text-white py-20 px-6 md:px-16 rounded-tl-[60px] rounded-br-[60px] max-w-7xl mx-4 md:mx-auto my-14 shadow-xl">
