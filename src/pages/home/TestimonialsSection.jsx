...
const testimonials = [
  {
    ...
    quote:
      "Hemant Fertilizers products helped me increase my wheat yield by 30%! Truly reliable and affordable.",
    image: pic1,
  },
  {
    name: "Avneesh Dixit",
...
const TestimonialsSection = () => {
  return (
    <section className="bg-orange-50 py-20 px-6 md:px-12" id="testimonials">
