    ...
    >
      <div className="pl-6 pr-6 py-2 flex justify-between items-center">
        ...
        <div className="hidden md:block">
          <a
            href="#quote"
            className="bg-white text-[#0B3E2A] px-5 py-2 rounded-full hover:bg-[#e6952d] transition text-xl font-semibold transform hover:scale-105 duration-200 shadow-md hover:shadow-xl"
          >
            Get a Quote
          </a>
        </div>
